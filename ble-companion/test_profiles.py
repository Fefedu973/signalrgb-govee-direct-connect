...
class ProfileTests(unittest.TestCase):
    ...
    def test_registry_metadata_and_backward_default(self):
        ...
        self.assertFalse(old.black_at_zero_brightness)
        self.assertTrue(self.profile.black_at_zero_brightness)
        self.assertFalse(old.power_off_on_black)
        self.assertTrue(self.profile.power_off_on_black)
